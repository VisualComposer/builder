...
<ul><li>- Check if your server has a connection to the Internet.</li><li>- Check if your server proxy has proper configuration settings.</li><li>- Check your server firewall settings and access to https://account.visualcomposer.io</li><li>- Check if your server has access to the <a href="https://aws.amazon.com/ru/premiumsupport/knowledge-center/s3-find-ip-address-ranges/" target="_blank" rel="noopener noreferrer">Amazon AWS Region: `us-west-2` IP</a></li></ul>',
            ...
            'thisIsYourContentLibrary' => __(
                'This is your content library. <a href="https://visualcomposer.com/help/content-elements-structure/add-content-element/?utm_source=vcwb&utm_medium=editor&utm_campaign=info&utm_content=help-guide" target="_blank" rel="noopener noreferrer">Add an element</a> by dragging or clicking on it and find templates you have created or downloaded from the <a href="https://visualcomposer.com/help/visual-composer-hub/" target="_blank" rel="noopener noreferrer">Hub</a>.',
                'visualcomposer'
            ),
            'useElementControls' => __(
                'Use <a href="https://visualcomposer.com/help/interface/element-controls/?utm_source=vcwb&utm_medium=editor&utm_campaign=info&utm_content=help-guide" target="_blank" rel="noopener noreferrer">element controls</a> to see your <a href="https://visualcomposer.com/help/content-elements-structure/grid-layout-row-column/" target="_blank" rel="noopener noreferrer">layout structure</a> or modify the particular row, column, or content element.',
                'visualcomposer'
            ),
            'useQuickActions' => __(
                'Use <a href="https://visualcomposer.com/help/content-elements-structure/add-content-element/?utm_source=vcwb&utm_medium=editor&utm_campaign=info&utm_content=help-guide" target="_blank" rel="noopener noreferrer">quick actions</a> at the bottom of the page to add the most popular row/column layouts and elements.',
                'visualcomposer'
            ),
            'validateYourPage' => __(
                '<a href="https://visualcomposer.com/help/visual-composer-insights-assistant/?utm_source=vcwb&utm_medium=editor&utm_campaign=info&utm_content=help-guide" target="_blank" rel="noopener noreferrer">Validate your page</a> for SEO and performance to speed up your site and rank higher.',
                'visualcomposer'
            ),
            'checkHowYourPageLooksOnDifferentDevices' => __(
                'Check how your page looks on different devices. Select the device type to <a href="https://visualcomposer.com/help/responsive-design/?utm_source=vcwb&utm_medium=editor&utm_campaign=info&utm_content=help-guide" target="_blank" rel="noopener noreferrer">preview your layout responsiveness</a>.',
                'visualcomposer'
            ),
            'accessVisualComposerHub' => __(
                'Access <a href="https://visualcomposer.com/help/visual-composer-hub/?utm_source=vcwb&utm_medium=editor&utm_campaign=info&utm_content=help-guide" target="_blank" rel="noopener noreferrer">Visual Composer Hub</a> in-built cloud library to download additional elements, templates, addons, stock images, and more.',
                'visualcomposer'
            ),
            'changeSettingsOfYourPageOrPost' => __(
                'Change <a href="https://visualcomposer.com/help/settings/?utm_source=vcwb&utm_medium=editor&utm_campaign=info&utm_content=help-guide" target="_blank" rel="noopener noreferrer">settings of your page or post</a>, modify the layout, control popups, add custom CSS, and Javascript.',
                'visualcomposer'
            ),
