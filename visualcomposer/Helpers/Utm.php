...
class Utm implements Helper
{
    ...
    public function all()
    {
        ...
        $utm = [
            ...
            'editor-popup-settings-go-premium' => 'https://visualcomposer.com/premium/?utm_source=' . $source . '&utm_medium=popup-settings-editor&utm_campaign=gopremium&utm_content=go-premium-button',

            // Editor Element Lock(Role Manager) addon settings teaser
            'editor-element-lock-settings-go-premium' => 'https://visualcomposer.com/premium/?utm_source=' . $source . '&utm_medium=element-lock-settings-editor&utm_campaign=gopremium&utm_content=go-premium-button',
        ];
