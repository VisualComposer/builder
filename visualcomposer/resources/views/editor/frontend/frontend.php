...
<script>
  ...
  window.vcvGoPremiumUrl = '<?php echo set_url_scheme(admin_url('admin.php?page=vcv-go-premium&vcv-activate=1&vcv-ref=nav-bar')); ?>';
  window.vcvGoPremiumUrlLogo = '<?php echo set_url_scheme(admin_url('admin.php?page=vcv-go-premium&vcv-activate=1&vcv-ref=logoFrontend')); ?>';
