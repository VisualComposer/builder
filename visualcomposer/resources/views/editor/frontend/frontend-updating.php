					...
					<div class="vcv-loading-overlay">
						<div class="vcv-loading-overlay-inner">
							...
							<div class="vcv-loading-text">
								<p class="vcv-loading-text-main">We are updating assets from the Visual Composer Cloud
									... Please wait.</p>
								<p class="vcv-loading-text-helper">Don’t close this window while update is in
									process.</p>
							</div>
						</div>
