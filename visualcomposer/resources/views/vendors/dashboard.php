...
<div class="rss-widget">
    ...
    <a href="<?php echo $utmHelper->get('wp-dashboard-news-logo'); ?>" target="_blank" rel="noopener noreferrer" class="vcwb-logo">
    ...
    <ul>
        ...
        if (isset($rssItems) && !empty($rssItems)) :
            foreach ($rssItems as $item) :
                ...
                ?>
                <li>
                    <a href="<?php echo $permalink . $utmHelper->get('wp-dashboard-news-blog-post'); ?>" class="rsswidget" rel="noopener noreferrer" title=" <?php echo $title; ?>"
                       target="_blank">
                        <?php echo $title; ?>
                    </a>
    ...
    <p class="vcwb-rss-widget-bottom community-events-footer">
        <a href="<?php echo $utmHelper->get('wp-dashboard-news-blog'); ?>" target="_blank" rel="noopener noreferrer"
        ...
        <?php if (!vchelper('License')->isPremiumActivated()) : ?>
            |
            <a href="<?php echo $utmHelper->get('wp-dashboard-news-gopremium'); ?>" target="_blank"  rel="noopener noreferrer"
