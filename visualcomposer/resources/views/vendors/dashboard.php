...
<div class="rss-widget">
    ...
    <ul>
        ...
        if (isset($rssItems) && !empty($rssItems)) :
            foreach ($rssItems as $item) :
                ...
                ?>
                <li>
                    <a href="<?php echo $permalink; ?>" class="rsswidget" title=" <?php echo $title; ?>"
                       target="_blank">
                        <?php echo $title; ?>
                    </a>
    ...
    <p class="community-events-footer" style="margin: 10px -11px -16px -11px">
        <a href="<?php echo $utmHelper->get('dashboardNewsBlog'); ?>" target="_blank"
           class="vcwb-rss-widget-link vcwb-rss-widget-link--blog">
            <?php echo esc_html__('Blog', 'visualcomposer'); ?>
            <span aria-hidden="true" class="dashicons dashicons-external"></span>
        </a>
        |
        <a href="<?php echo $utmHelper->get('dashboardNewsGoPremium'); ?>" target="_blank"
