...
<div class="vcv-popup-content vcv-popup-go-premium-screen">
	...
	<form class="vcv-popup-form vcv-popup-form-light-theme" id="vcv-premium-activation-form" method="post" action="<?php echo esc_url(
        admin_url('admin.php?page=vcv-upgrade')
    ); ?>">
        ...
        <?php if (!vcvenv('VCV_FT_ACTIVATION_FIELDS_MOVE')) : ?>
			<div class="vcv-popup-form-checkbox">
				...
				<span class="vcv-popup-form-checkbox-label">
					<?php
						printf(
						// @codingStandardsIgnoreLine
							__(
								'I have read and agree to the <a href="%1$s" target="_blank">Terms of Use</a> and <a href="%2$s"" target="_blank">Cloud Access Terms</a>',
								'vcwb'
							),
		...
		<input type="submit" value="<?php echo esc_html__(
            'Activate Premium',
            'vcwb'
        ); ?>" class="vcv-activate-premium vcv-popup-button" id="vcv-activate-premium-button">
	</form>
	<span class="vcv-popup-slider-item-text"><?php echo esc_html__(
            'Unlock the most powerful and simplest way to create a professional website for your business.',
            'vcwb'
        ); ?></span>
