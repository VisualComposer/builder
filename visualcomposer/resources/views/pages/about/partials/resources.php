<div class="vc_resources-tab changelog">
	<div class="feature-section vc_row">
		<div class="vc_col-xs-6">
			<h3><?= __( 'Resources', 'vc5' ) ?></h3>

			<p><?= __( 'There are several resources available to Visual Composer users to help you to get around plugin:', 'vc5' ) ?></p>
