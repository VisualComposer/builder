...
<script>
  ...
  window.vcvUpdateUrl = '<?php
      // @codingStandardsIgnoreLine
      echo $urlHelper->adminAjax(['vcv-action' => 'bundle:update:adminNonce']);
        ?>';
  ...
  window.vcvActionsUrl = '<?php
      // @codingStandardsIgnoreLine
      echo vchelper('Url')->adminAjax(['vcv-action' => 'hub:action:adminNonce']);
        ?>';
  window.vcvUpdateFinishedUrl = '<?php
      // @codingStandardsIgnoreLine
      echo vchelper('Url')->adminAjax(['vcv-action' => 'bundle:update:finished:adminNonce']);
        ?>';
  window.vcvAjaxTime = <?php echo esc_attr($time); ?>;
  window.vcvPageBack = '<?php echo esc_url($optionsHelper->getTransient('_vcv_update_page_redirect_url')); ?>';
  window.vcvAjaxUrl = '<?php
      // @codingStandardsIgnoreLine
      echo vchelper('Url')->ajax();
        ?>';
  window.vcvAdminAjaxUrl = '<?php
      // @codingStandardsIgnoreLine
      echo vchelper('Url')->adminAjax();
        ?>';
  window.vcvErrorReportUrl = '<?php
      // @codingStandardsIgnoreLine
      echo vchelper('Url')->adminAjax(['vcv-action' => 'account:error:report:adminNonce']);
        ?>';
  window.vcvElementsGlobalsUrl = '<?php
      // @codingStandardsIgnoreLine
      echo vchelper('Url')->adminAjax(['vcv-action' => 'elements:globalVariables:adminNonce']);
        ?>';
  ...
  window.vcvVendorUrl = '<?php echo esc_url(content_url() . '/' . VCV_PLUGIN_ASSETS_DIRNAME . '/editor/vendor.bundle.js'); ?>';
    <?php else : ?>
  window.vcvUpdaterUrl = '<?php
      // @codingStandardsIgnoreLine
      echo vchelper('Url')->to('public/dist/wpPostRebuild.bundle.js');
        ?>';
  window.vcvVendorUrl = '<?php
      // @codingStandardsIgnoreLine
      echo vchelper('Url')->to('public/dist/vendor.bundle.js');
        ?>';
    <?php endif; ?>
</script>
