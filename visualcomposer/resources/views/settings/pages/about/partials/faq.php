    ...
    <div class="feature-section vc_row">
        <div class="vc_col-xs-4">
            ...
            <ul>
                ...
                <li><a target="_blank" href="http://go.wpbakery.com/support-and-resources">Support and Resources</a>
                </li>
        ...
        <div class="vc_col-xs-4">
            ...
            <ul>
                ...
                <li>
                    <a target="_blank" href="http://go.wpbakery.com/in-stock-license-terms">In-Stock License (Theme
                        Integration)</a>
                </li>
            </ul>
        </div>
    ...
    <div class="feature-section vc_row">
        <div class="vc_col-xs-4">
            ...
            <ul>
                ...
                <li><a target="_blank" href="http://go.wpbakery.com/element-design-options">Element Design Options</a>
                </li>
    ...
    <div class="feature-section vc_row">
        <div class="vc_col-xs-4">
            ...
            <ul>
                ...
                <li>
                    <a target="_blank" href="http://go.wpbakery.com/addon-development-rules">Add-on Development
                        Rules</a>
                </li>
            </ul>
        </div>
