...
<div class="vcv-welcome-tab changelog">
    ...
    <div class="vcv-feature-section-teaser">
        <div>
            ...
            <h3><?php echo __('New Elements and Options', 'vcwb') ?></h3>
            <p><?php echo __(
    ...
    <div class="vcv-welcome-feature feature-section vcv-row">
        ...
        <div class="vcv-col-xs-4">
            ...
            <h4><?php echo __('ACF Support', 'vcwb') ?></h4>
            <p><?php echo __(
        ...
        <div class="vcv-col-xs-4">
            ...
            <h4><?php echo __('Categories and Authors', 'vcwb') ?></h4>
            <p><?php echo __(
