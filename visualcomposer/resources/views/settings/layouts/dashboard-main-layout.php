...
$parentSlug = $activeTabData['parent'];
...
if (isset($allTabs[ $parentSlug ]['children'])) {
    $subTabs = $allTabs[ $parentSlug ]['children'];
    foreach ($subTabs as $tabKey => $tab) {
        ...
        $tabsHtml .= '<a href="#' . esc_attr($tabKey) . '" class="vcv-dashboard-tab' . esc_attr($activeClass)
            . '" data-value="' . esc_attr($tabKey) . '">'
                ...
                <nav class="vcv-dashboard-sidebar-navigation vcv-dashboard-sidebar-navigation--main">
                    <ul class="vcv-dashboard-sidebar-navigation-menu">
                        <li class="vcv-dashboard-sidebar-navigation-menu-item">
                            <a class="vcv-dashboard-sidebar-navigation-link vcv-ui-icon-dashboard vcv-ui-icon-dashboard-hub-shop" href="#hub">Visual Composer Hub</a>
                        </li>
                        <li class="vcv-dashboard-sidebar-navigation-menu-item">
                            <a class="vcv-dashboard-sidebar-navigation-link vcv-dashboard-sidebar-navigation-link--active vcv-ui-icon-dashboard vcv-ui-icon-dashboard-settings" href="#settings">Settings</a>
                            <ul class="vcv-dashboard-sidebar-navigation-menu vcv-dashboard-sidebar-navigation-menu--submenu">
                                <li class="vcv-dashboard-sidebar-navigation-menu-item">
                                    <a class="vcv-dashboard-sidebar-navigation-link vcv-ui-icon-dashboard" href="#vcv-settings">Settings</a>
                                </li>
                                <li class="vcv-dashboard-sidebar-navigation-menu-item">
                                    <a class="vcv-dashboard-sidebar-navigation-link vcv-ui-icon-dashboard" href="#vcv-system-status">System Status</a>
                                </li>
                            </ul>
                        </li>
                        <li class="vcv-dashboard-sidebar-navigation-menu-item">
                            <a class="vcv-dashboard-sidebar-navigation-link vcv-ui-icon-dashboard vcv-ui-icon-dashboard-css" href="#css-html-js">CSS, HTML &amp; JavaScript</a>
                        </li>
                    </ul>
                </nav>
