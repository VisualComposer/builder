 ...
 */
class VcPostsListTable extends \WP_List_Table
{
    /**
    ...
    public function __construct($args = [])
    {
        ...
        if ('post' === $post_type && $sticky_posts) {
            ...
            $this->sticky_posts_count = $wpdb->get_var(
                $wpdb->prepare(
                    "SELECT COUNT( 1 ) FROM $wpdb->posts WHERE post_type = %s AND post_status NOT IN ('trash', 'auto-draft') AND ID IN ($sticky_posts)",
                    $post_type
                )
            );
        }
    ...
    public function prepare_items()
    {
        ...
        // Is going to call wp().
        // VCWB modification
        $avail_post_stati = wp_edit_posts_query(array_merge($_GET, ['post_type' => $this->screen->post_type]));
        // END VCWB
        $this->set_hierarchical_display(
            is_post_type_hierarchical($this->screen->post_type) && 'menu_order title' === $wp_query->query['orderby']
        );
    ...
    // VCWB:
    // THE REST IS COPY OF Posts_Lists_Table, but we cannot extend it as it have "PRIVATE" scope for $is_trash and other simillar issues
    ...
    protected function formats_dropdown($post_type)
    {
        ...
        <select name="post_format" id="filter-by-format">
            ...
            foreach ($used_post_formats as $used_post_format) {
                ...
                ?>
                <option<?php selected($displayed_post_format, $slug); ?> value="<?php echo esc_attr(
                    $slug
                ); ?>"><?php echo esc_html($pretty_name); ?></option>
                <?php
            }
            ?>
        </select>
    ...
    public function get_columns()
    {
        ...
        if (post_type_supports($post_type, 'comments')
            ...
            $posts_columns['comments'] = '<span class="vers comment-grey-bubble" title="' . esc_attr__('Comments')
                . '"><span class="screen-reader-text">' . __('Comments') . '</span></span>';
        }
    ...
    public function column_title($post)
    {
        ...
        if ($can_edit_post && 'trash' !== $post->post_status) {
            ...
            echo '<div class="locked-info"><span class="locked-avatar">' . $locked_avatar
                . '</span> <span class="locked-text">' . $locked_text . "</span></div>\n";
        }
    ...
    public function column_comments($post)
    {
        ...
        <div class="post-com-count-wrapper">
            ...
            $pending_comments = isset($this->comment_pending_count[ $post->ID ])
                ? $this->comment_pending_count[ $post->ID ] : 0;
        ...
        if (current_user_can('delete_post', $post->ID)) {
            if ('trash' === $post->post_status) {
                $actions['untrash'] = sprintf(
                    '<a href="%s" aria-label="%s">%s</a>',
                    wp_nonce_url(
                        admin_url(sprintf($post_type_object->_edit_link . '&amp;action=untrash', $post->ID)),
        ...
        <form method="get">
            <table style="display: none">
                ...
                while ($bulk < 2) :
                    ...
                    ?>
                    <tr id="<?php echo $bulk ? 'bulk-edit'
                        : 'inline-edit'; ?>" class="<?php echo $classes; ?>" style="display: none">
                        <td colspan="<?php echo $this->get_column_count(); ?>" class="colspanchange">

                            <fieldset class="inline-edit-col-left">
                                <legend class="inline-edit-legend"><?php echo $bulk
                                        ? __('Bulk Edit')
                                        : __(
                                            'Quick Edit'
                                        ); ?></legend>
                                ...
                                <fieldset class="inline-edit-col-center inline-edit-categories">
                                    <div class="inline-edit-col">
                                        ...
                                        <?php foreach ($hierarchical_taxonomies as $taxonomy) : ?>
                                            ...
                                            <ul class="cat-checklist <?php echo esc_attr(
                                                $taxonomy->name
                                            ); ?>-checklist">
                                                <?php wp_terms_checklist(null, ['taxonomy' => $taxonomy->name]); ?>
                                            </ul>
                            ...
                            <fieldset class="inline-edit-col-right">
                                <div class="inline-edit-col">
                                        ...
                                        <?php foreach ($flat_taxonomies as $taxonomy) : ?>
                                            ...
                                            <?php if (current_user_can($taxonomy->cap->assign_terms)) : ?>
                                                ...
                                                <label class="inline-edit-tags">
                                                    <span class="title"><?php echo esc_html(
                                                            $taxonomy->labels->name
                                                        ); ?></span>
                                            ...
                                            <div class="inline-edit-group wp-clearfix">
                                                ...
                                                <?php if (post_type_supports($screen->post_type, 'comments')) : ?>
                                                    ...
                                                    <label class="alignleft">
                                                        ...
                                                        <span class="checkbox-title"><?php _e(
                                                                'Allow Comments'
                                                            ); ?></span>
                                                    </label>
                                    ...
                                    <div class="inline-edit-group wp-clearfix">
                                        ...
                                        <?php if ('post' === $screen->post_type && $can_publish
                                            && current_user_can(
                                    ...
                                    <?php if ($bulk && current_theme_supports('post-formats')
                                        && post_type_supports(
                                            $screen->post_type,
                                            'post-formats'
                                        )) : ?>
                                        ...
                                        <label class="alignleft">
                                            ...
                                            <select name="post_format">
                                                ...
                                                <option value="0"><?php echo get_post_format_string(
                                                        'standard'
                                                    ); ?></option>
                            ...
                            <div class="submit inline-edit-save">
                                ...
                                <?php if (!$bulk) : ?>
                                    ...
                                    <button type="button" class="button button-primary save alignright"><?php _e(
                                            'Update'
                                        ); ?></button>
