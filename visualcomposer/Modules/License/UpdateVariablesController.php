    ...
    protected function addVariables($variables, $payload, Update $updateHelper, Url $urlHelper)
    {
        ...
        if ($payload['slug'] === 'vcv-about') {
            ...
            $variables[] = [
                ...
                'value' => [
                    [
                        'url' => esc_js('http://cdn.hub.visualcomposer.com/plugin-assets/slideshow-01.png'),
                        'title' => esc_js(
                            __(
                    ...
                    [
                        'url' => esc_js('http://cdn.hub.visualcomposer.com/plugin-assets/slideshow-02.png'),
                        'title' => esc_js(
                            __(
                    ...
                    [
                        'url' => esc_js('http://cdn.hub.visualcomposer.com/plugin-assets/slideshow-03.png'),
                        'title' => esc_js(
                            __(
                    ...
                    [
                        'url' => esc_js('http://cdn.hub.visualcomposer.com/plugin-assets/slideshow-04.png'),
                        'title' => esc_js(
                            __(
