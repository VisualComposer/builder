...
class FrontendEditor extends Container {
	 ...
	 * @var array
	 */
	protected static $contentEditorSettings = array(
		'dfw' => true,
	...
	public function parseEditableContent( $post ) {
		...
		if ( $postId > 0 && $post->ID === $postId && ! defined( 'VC_LOADING_EDITABLE_CONTENT' ) ) {
			...
			ob_start();
			vc_include_template( 'editors/partials/postShortcodes.tpl.php', array( 'editor' => $this ) );
	...
	function renderEditor() {
		...
		wp_enqueue_media( array( 'post' => $this->postId ) );
