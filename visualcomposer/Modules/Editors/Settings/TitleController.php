...
class TitleController extends Container implements Module
{
    ...
    public function __construct()
    {
        ...
        $this->wpAddFilter('wp_robots', 'removeTitleFilter');
        $this->wpAddFilter('wp_robots', 'addTitleFilter', \PHP_INT_MAX - 9);

        // Prevent removing the title from breadcrumbs generated by "Weaver Xtreme" theme.
        $this->wpAddFilter('weaverx_breadcrumb_delimiter', 'removeTitleFilter');
        $this->wpAddFilter('weaverx_breadcrumbs', 'addTitleFilter');
