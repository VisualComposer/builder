...
function vcLogWpErrorByCode($code, $errorMessage)
{
    ...
    if (!empty($message)) {
        $message .= PHP_EOL
            . '<span style="font-style: italic;">You may need to contact your hosting provider for assistance. If the problem still occurs, visit <a href="https://support.visualcomposer.io/" target="_blank">support.visualcomposer.io</a> for technical assistance</span>';
    }
