...
ControlsHandler.prototype.setControlsPosition = function (  ) {
    ...
    if (this.$currentElement !== undefined && this.$controlsContainer !== null) {
        posTop = this.$currentElement.offset().top-this.$currentElement.closest('body').scrollTop()+this.$currentElement.closest('body').offset().top+50; // @todo FIX THIS!!! IT IS WRONG!
