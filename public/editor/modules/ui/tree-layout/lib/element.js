...
var Element = React.createClass({
  ...
  render: function() {
    ...
    var child = 'container' == element.get('type') ? this.getContent() : ''; // yes == not === it is required :P
    this.state.hasChild = !!child;
    var addChildControl = 'container' == element.get('type') ?
      <a className="vc-ui-tree-layout-control-action" title="Add" onClick={this.clickAddChild}><i
        className="vc-ui-icon vc-ui-icon-add-thin"></i></a> : false;
    ...
    var childControls =
      <span className="vc-ui-tree-layout-control-actions">
        {addChildControl}
        <a className="vc-ui-tree-layout-control-action" title="Edit" onClick={this.clickEdit}><i
          className="vc-ui-icon vc-ui-icon-edit"></i></a>
        <a className="vc-ui-tree-layout-control-action" title="Delete" onClick={this.clickDelete}><i
          className="vc-ui-icon vc-ui-icon-close-thin"></i></a>
        <a className="vc-ui-tree-layout-control-action" title="Clone" onClick={this.clickClone}><i
          className="vc-ui-icon vc-ui-icon-copy"></i></a>
      </span>;
    return <li className={treeChildClass}>
      <div className="vc-ui-tree-layout-control" style={{paddingLeft: this.props.level + 1 + 'em'}}>
        <div className="vc-ui-tree-layout-control-drag-handler"><i
          className="vc-ui-tree-layout-control-drag-handler-icon vc-ui-icon vc-ui-icon-drag-dots"></i></div>
