  ...
  render: function() {
    ...
    return (
      <div className={cssClass} key={key} {...editor}>
        <span className="vc-sep-holder vc-sep-holder-l"><span {...inlineCss}
          className="vc-sep-line"></span></span>{content}<span
        className="vc-sep-holder vc-sep-holder-r"><span {...inlineCss} className="vc-sep-line"></span></span>
      </div>
    );
  }
});
