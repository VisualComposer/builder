...
export default class AutoComplete extends Attribute {
  ...
  render () {
    const { value, fieldKey, elementAccessPoint, options, extraClass, description, suggestions, suggestionsOnFocus, handleInputChange, isNewAutocomplete, isSuggestionsLoading } = this.props
    ...
    if (!isNewAutocomplete) {
      ...
      return (
        <ReactTagContainer
          ...
          suggestionsOnFocus={suggestionsOnFocus}
          fieldKey={fieldKey}
