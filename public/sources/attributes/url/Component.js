...
export default class Url extends Attribute {
  ...
  renderExistingPosts = () => {
    ...
    if (!this.state.posts || !this.state.posts.length) {
      return (
        <div className='vcv-ui-form-no-content'>
    ...
    this.state.posts.map((post) => {
      items.push(
        <li key={'vcv-selectable-post-url-' + post.id} className='vcv-ui-selectable-posts-list-item'>
          <a href={post.url} onClick={this.handlePostSelection}>
    ...
    return (
      <ul className='vcv-ui-selectable-posts-list-container'>
        {items}
      </ul>
    )
  }
