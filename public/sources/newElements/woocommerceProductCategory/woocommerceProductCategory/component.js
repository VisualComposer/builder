...
export default class WoocommerceProductCategory extends vcvAPI.elementComponent {
  state = {
    shortcode: { __html: '' },
  ...
  requestToServer () {
    ...
    let atts = {
      ...
      category: this.props.atts.atts_category
    }
    this.serverRequest = ajax({
      'vcv-action': 'elements:woocommerce:product_category:adminNonce',
