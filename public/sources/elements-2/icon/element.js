window.vcvAddElement(
  ...
  function(component) {
    ...
    component.add(React.createClass({
      render: function() {
        // import variables
        var {fontawesomeIcons, lineIcons, entypoIcons, monosocialIcons, typiconsIcons, openiconicIcons, id, content, ...other} = this.props
        // import template js
