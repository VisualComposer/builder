...
/***/ function(module, exports, __webpack_require__) {
	...
	var Mediator = __webpack_require__(1); // need to remove
	var App = {
		loadModules: function loadModules() {
			...
			// Data Storage module
			var Data = __webpack_require__(205);
			// Editor Controls
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EditorUI = __webpack_require__(161);
	var Mediator = __webpack_require__(1); // need to remove
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(3);
	var Mediator = __webpack_require__(1); // need to remove too

	var Navbar = __webpack_require__(162);
	var HtmlLayout = __webpack_require__(208);
	var EditForm = __webpack_require__(216);
	                        ...
	                        React.createElement(
	                            ...
	                            React.createElement(
	                                ...
	                                Object.keys(elements).map(function (key) {
	                                    ...
	                                    return React.createElement(ElementControl, _extends({ key: 'vc-element-control-' + element.tag }, element));
	                                })
	                            )
	                        )
	                    )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var renderSubtreeIntoContainer = __webpack_require__(160).unstable_renderSubtreeIntoContainer;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Mediator = __webpack_require__(1);
	var ElementsSettings = __webpack_require__(186);
	var ElementsList = {
	    elements: false
	};
	...
	var Elements = {
	    ...
	    getElement: function getElement(element) {
	        return __webpack_require__(187)("./" + element.tag + '/' + element.tag + '.js');
	    },
	    getElementSettings: function getElementSettings(tag) {
	...
	var Paragraph = React.createClass({
	    ...
	    render: function render() {
	        ...
	        return React.createElement(
	            ...
	            content ? 'Hello my name is Boris and I know ninja rules very well. Hide away.' : '',
	            controls || ''
	        );
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Mediator = __webpack_require__(1);
	var Utils = __webpack_require__(184);
	var LocalStorage = __webpack_require__(206);
	...
	var Layout = React.createClass({
	    ...
	    render: function render() {
	        ...
	        if (this.props.data.childNodes) {
	            ...
	            elementsList = data.map(function (element) {
	                var data = Array.prototype.slice.call(element.childNodes);
	                return React.createElement(Element, { element: { tag: element.tagName, id: element.getAttribute('id') }, data: data, key: element.getAttribute('id') });
	            });
	        }
	        return React.createElement(
	            'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Element = React.createClass({
	    ...
	    getControls: function getControls() {
	        var addControl = 'Section' === this.props.element.tag ? React.createElement('a', { onClick: this.addChild, className: 'glyphicon glyphicon-plus' }) : null;
	        return React.createElement(
	            'span',
	            { className: 'controls' },
	            addControl,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Mediator = __webpack_require__(1); // need to remove too
	var Modal = __webpack_require__(163);
	var Elements = __webpack_require__(185);
	var customStyles = {
	    content: {
	        top: '50%',
	        left: '50%',
