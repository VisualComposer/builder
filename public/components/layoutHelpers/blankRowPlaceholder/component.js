...
export default class BlankRowPlaceholder extends React.Component {
    ...
    return [
      {
        ...
        options: {
          layout: { all: ['auto'] },
          icon: ['default', 'template', 'archive', 'popup'].indexOf(BlankRowPlaceholder.editorType) !== -1 ? oneColumnIcon : oneColumnIconLight,
      ...
      },
      {
        ...
        options: {
          ...
          icon: ['default', 'template', 'archive', 'popup'].indexOf(BlankRowPlaceholder.editorType) !== -1 ? twoColumnsIcon : twoColumnsIconLight,
      ...
      },
      {
        ...
        options: {
          ...
          icon: ['default', 'template', 'archive', 'popup'].indexOf(BlankRowPlaceholder.editorType) !== -1 ? threeColumnsIcon : threeColumnsIconLight,
      ...
      },
      {
        ...
        options: {
          ...
          icon: ['default', 'template', 'archive', 'popup'].indexOf(BlankRowPlaceholder.editorType) !== -1 ? fourColumnsIcon : fourColumnsIconLight,
      ...
      },
      {
        ...
        options: {
          ...
          icon: ['default', 'template', 'archive', 'popup'].indexOf(BlankRowPlaceholder.editorType) !== -1 ? fiveColumnsIcon : fiveColumnsIconLight,
      ...
      },
      {
        ...
        options: {
          ...
          icon: ['default', 'template', 'archive', 'popup'].indexOf(BlankRowPlaceholder.editorType) !== -1 ? customIcon : customIconLight,
      ...
      },
      {
        tag: 'textBlock',
        options: {
          icon: ['default', 'template', 'archive', 'popup'].indexOf(BlankRowPlaceholder.editorType) !== -1 ? textBlockIcon : textBlockIconLight,
      ...
      },
      {
        tag: 'addElement',
        options: {
          icon: ['default', 'template', 'archive', 'popup'].indexOf(BlankRowPlaceholder.editorType) !== -1 ? addElementIcon : addElementIconLight,
      ...
      },
      {
        tag: 'paste',
        options: {
          icon: ['default', 'template', 'archive', 'popup'].indexOf(BlankRowPlaceholder.editorType) !== -1 ? pasteIcon : pasteIconLight,
  ...
  render () {
    ...
    const dragOverlayIcon = ['default', 'template', 'archive', 'popup'].indexOf(BlankRowPlaceholder.editorType) !== -1 ? addElementIcon : addElementIconLight
