...
export default class ElementsLock extends React.Component {
  ...
  render () {
    ...
    const lockSpecificDescriptionText = localizations ? localizations.lockSpecificDescriptionText : 'You can lock/unlock specific elements under element edit window.'
