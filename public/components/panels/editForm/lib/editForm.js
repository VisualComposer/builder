...
export default class EditForm extends React.Component {
  ...
  getTabs () {
    const tabs = {}
    const contentAllowed = env('VCV_ADDON_ROLE_MANAGER_ENABLED') && !env('VCV_ADDON_ROLE_MANAGER_EDIT_WINDOW_ENABLED') && roleManager.can('edit_window_contentTab', roleManager.defaultAdmin())
    // Backwards compatibility
    ...
    // Apply user roles
    if (env('VCV_ADDON_ROLE_MANAGER_ENABLED') && !env('VCV_ADDON_ROLE_MANAGER_EDIT_WINDOW_ENABLED')) {
