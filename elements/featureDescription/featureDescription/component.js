...
export default class FeatureDescription extends vcvAPI.elementComponent {
  ...
  render () {
    ...
    let { description, image, addButton, button, shape, alignment, size, metaCustomId, customClass } = atts
    let containerProps = {}
    let containerClasses = 'vce-feature-description vce'

    let imageSizes = window.vcvImageSizes ? window.vcvImageSizes : { thumbnail: { width: 150 }, medium: { width: 300 }, large: { width: 1024 } }
    ...
    return <div className={containerClasses} id={'el-' + id} {...editor} {...doAll}>
      <div {...containerProps}>
